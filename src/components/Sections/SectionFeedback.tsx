    ...
    <section className="relative overflow-hidden mb-32">
      <div className="bg-[#F7FAFF] my-4 pb-44 pt-24">
        ...
        <div className="flex flex-col gap-y-2 items-center ">
          ...
          <div className="text-[#2A2A2A] text-5xl text-center leading-[66px] font-inter">
            What's Our Client Say
            <br /> About Us
          </div>
        </div>
        <div className="grid grid-cols-3 gap-8 px-10 mt-28">
          {list.map((item, key) => (
            <CardItem
              key={key}
              text={item.text}
...
function CardItem({
  ...
  return (
    <div className="bg-white pl-10 pr-[41px] py-14 flex flex-col gap-y-10 font-inter">
      <div className="text-[#2C2C2C] text-xl leading-[37.8px]">{text}</div>
